...
```bash
git clone git@github.com:um-programacion-ii/programacion-2-trabajo-practico-3-Emicora.git
cd programacion-2-trabajo-practico-3-Emicora/SistemaDeGestion
mvn test
```
